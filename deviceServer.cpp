...
{
    ui.setupUi(this);
    m_Tcp_Server = new MyTcpServer(this);
    ...
    handle = 0;
    connect(m_Tcp_Server,&MyTcpServer::connectClient,this,[=](qintptr socketDescript,QString address,unsigned short port){
        ...
        connect(m_Tcp_Server,&MyTcpServer::signal_TowCount,this,[=](int socketDescript,int TowCount){
        ...
        connect(m_Tcp_Server,&MyTcpServer::signal_haveVehInfo,this,[=](int,QString vehInfo,int vechicount){
        ...
        connect(m_Tcp_Server,&MyTcpServer::signal_haveTotalTime,this,[=](int handle,QString Info){
            ui.totalTime->setText(Info);
        });

        connect(m_Tcp_Server,&MyTcpServer::signal_haveavgTime,this,[=](int handle,QString Info){
            ui.avgTime->setText(Info);
        });

        connect(m_Tcp_Server,&MyTcpServer::signal_havesuccessRate,this,[=](int handle,QString Info){
            ui.successRate->setText(Info);
        });

    },Qt::UniqueConnection);

    connect(m_Tcp_Server,&MyTcpServer::sockDisConnected,this,[=](qintptr socketDescript,QString address,unsigned short port){
